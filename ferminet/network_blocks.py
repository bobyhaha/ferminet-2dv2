...
def split_into_blocks(block_arr: jnp.ndarray,
  ...
  #itertool.chain is used to chain the iterables
  #The below is the same as itertools.chain(*block12)
...
#This only linearize with respect to x not w and b, which are shared
